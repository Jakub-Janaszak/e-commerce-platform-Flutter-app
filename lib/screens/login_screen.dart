...
class LoginScreen extends StatelessWidget {
  ...
  void _navigateToMainPageAsGuest(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => AnnouncementsScreen()));
  }
      ...
      body: Stack(
        children: [
          Container(
              ...
              child: Center(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius:
                        BorderRadius.circular(10.0), // Zaokrąglone rogi
                    border: Border.all(color: Colors.white), // Biała obwódka
                  ),
                  child: TextButton(
                    onPressed: () {
                      attemptLogin(loginController.text,
          ...
          Padding(
            ...
            child: TextButton(
                onPressed: () {
                  _navigateToMainPageAsGuest(context);
                },
                child: Text(
                  "Enter as a guest",
                  style: TextStyle(
